package com.zee.data.dataread.config;
...
@EnableJpaRepositories(basePackages = {"com.zee.data.dataread.repository"}, entityManagerFactoryRef = "zshopDataSourceEntityManager", transactionManagerRef = "zshopDataSourceTransactionManager")
public class ZshopDataSourceConfig {
	...
	//	em.setDataSource(dataSource());
		em.setDataSource(dataSource());
		em.setPackagesToScan("com.zee.data.dataread.entity");
